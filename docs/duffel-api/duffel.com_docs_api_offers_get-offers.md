---
url: "https://duffel.com/docs/api/offers/get-offers"
...
[Partial](https://duffel.com/docs/api/offers/get-offers#offers-schema-partial) offers contain a single slice as each partial offer is for a particular slice of the journey.
