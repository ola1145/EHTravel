...
| -------------------------------------- | --------------------------------------- | --------------------------------- |
| **QAS** (Quality Assurance Specialist) | `/docs/agent-outputs/qa-validations/`   | `EHT-{number}-qa-validation.md`   |
| **BSA** (Business Systems Analyst)     | `/docs/agent-outputs/requirements/`     | `EHT-{number}-requirements.md`    |
| **System Architect**                   | `/docs/adr/`                            | `ADR-{number}-{title}.md`         |
| **Tech Writer**                        | `/docs/agent-outputs/technical-docs/`   | `EHT-{number}-technical-docs.md`  |
| **Data Engineer**                      | `/docs/agent-outputs/technical-docs/`   | `EHT-{number}-migration-plan.md`  |
| **TDM** (Technical Delivery Manager)   | `/docs/agent-outputs/delivery-reports/` | `EHT-{number}-delivery-report.md` |
...
**Output Location**: `/docs/agent-outputs/qa-validations/EHT-{number}-qa-validation.md`
...
**Output Location**: `/docs/agent-outputs/requirements/EHT-{number}-requirements.md`
...
**Output Location**: `/docs/agent-outputs/technical-docs/EHT-{number}-technical-docs.md`
...
**Output Location**: `/docs/agent-outputs/technical-docs/EHT-{number}-migration-plan.md`
...
cat > /docs/agent-outputs/qa-validations/EHT-334-qa-validation.md <<EOF
## QA Validation Report - EHT-334
...
cat > /docs/agent-outputs/requirements/EHT-335-requirements.md <<EOF
## Requirements - EHT-335
...
cat > /docs/agent-outputs/technical-docs/EHT-336-migration-guide.md <<EOF
## Migration Guide - EHT-336
...
1. **During Work**: Agents write to `/docs/agent-outputs/{category}/EHT-{number}-*.md`
...
✅ Use Linear ticket number in filename (`EHT-{number}-*`)
