...
- Atomic commits in SAFe format: `feat(db): description [EHT-XXX]`
...
### NEW (EHT-314): PROD Migration & Schema Ownership
...
- Execute PROD migrations (with @ola1145 present - MANDATORY)
- Validate data integrity post-migration
- Update schema change history after each migration

## 📂 Output Location

**Migration Plans**: `/docs/agent-outputs/technical-docs/EHT-{number}-migration-plan.md`
...
**Naming Convention**: `EHT-{number}-migration-plan.md`
...
# Verify RLS enabled
docker exec -it ehtravel-db psql -U {{DB_USER}} -d {{DB_NAME}} \
...
**MANDATORY**: Before applying to production, get ARCHitect (@ola1145) review:
...
4. **Handoff Statement**
   > "DE implementation complete for EHT-XXX. Migration tested, ARCHitect approved. AC/DoD confirmed. Ready for QAS review."
