...
3. **Stage 3**: HITL (Ola McCartney) - Final merge authority
...
### NEW (EHT-314): Architecture & Governance Owner
...
ls specs/EHT-*-spec.md | grep "architecture|enabler"
...
cat specs/EHT-XXX-similar-feature-spec.md
```
...
2. **Technical Implementation Details**:
   ...
   - Fits into existing EHT architecture?
...
cat specs/EHT-XXX-similar-spec.md
```
...
- Spec: specs/EHT-YYY-{feature}-spec.md
- Linear: EHT-YYY
```
...
# Use mcp__linear__get_issue to load full context
```
...
```markdown
## System Architect PR Review - EHT-XXX (PR #XXX)
...
## Pattern Library Maintenance (EHT-300)
...
### When to Consult ARCHitect (ola1145)
...
4. **Handoff Statement**
   > "Stage 1 review complete for PR #XXX (EHT-YYY). Pattern compliance verified, RLS enforced. Approved for ARCHitect-in-CLI review (Stage 2)."
