...
```bash
# Example: EHT-381-rename-slash-commands-remote-prefix
git branch -d EHT-381-rename-slash-commands-remote-prefix
```
...
Latest:        fd85ba3 - feat(marketing): RenderTrust pages [EHT-379]
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Docker Services (EHT-401: STANDARD Ports)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

EHTravel-dev-app:        ✅ Up 3 hours (healthy) → port 3000
EHTravel-dev-postgres:   ✅ Up 3 hours (healthy) → port 5432
EHTravel-dev-redis:      ✅ Up 3 hours (healthy) → port 6379
