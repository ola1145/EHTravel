...
> **Note**: Tickets referenced in commit messages (e.g., `[EHT-XXX]`) auto-sync to Done when the PR merges via the GitHub-Linear integration. Manually close any child stories not referenced in commits.
