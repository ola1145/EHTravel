...
- Can monitor at: `https://ola1145/EHTravel/actions`
...
# Verify image exists
docker images | grep EHTravel

# EHT-400: Use EHTravel_IMAGE_TAG environment variable instead of editing compose file
# Set the tag before running docker compose:
export EHTravel_IMAGE_TAG=pr-{PR-number}

# Or update docker-compose.staging.yml image tag temporarily:
# Change: image: {{REGISTRY}}/EHTravel/dev:${{PROJECT}_IMAGE_TAG:-latest}
# To:     image: {{REGISTRY}}/EHTravel/dev:pr-{PR-number}
