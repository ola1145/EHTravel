...
mcp__linear__get_issue({ id: "EHT-459" })
...
**PR**: https://github.com/1145ai/ehtravel-org/pull/XXX
**Commit**: [short-hash]
**Branch**: EHT-XXX-description
...
**PR Merged**: https://github.com/1145ai/ehtravel-org/pull/XXX
**Merge Commit**: [hash]
...
Tickets referenced in commit messages (e.g., `[EHT-123]`) automatically move to **Done** when the PR merges. Child stories not referenced in any commit message must be manually closed after merge.
...
- Branch name contains `EHT-XXX`
- PR title contains `[EHT-XXX]`
