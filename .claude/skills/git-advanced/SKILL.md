...
git push --force-with-lease origin EHT-XXX-feature  # ✅ Safe
...
git rebase origin/dev && git push --force-with-lease origin EHT-XXX-feature
```
...
git push --force-with-lease origin EHT-XXX-feature
```
...
git add . && git commit -m "fix: address PR feedback [EHT-XXX]"
...
git log origin/EHT-XXX-feature..HEAD --oneline
