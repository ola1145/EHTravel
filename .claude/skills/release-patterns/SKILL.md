...
gh pr create --title "feat: add feature"  # Missing [EHT-XXX]
...
gh pr create --title "feat(scope): description [EHT-XXX]"
...
git push --force-with-lease origin EHT-XXX-description
```
...
- [ ] Commits follow: `type(scope): description [EHT-XXX]`
...
Prompt: "Review PR #XXX for EHT-YYY. Validate commit format, CI status, patterns."
```
