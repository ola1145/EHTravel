...
```
Create an agent team for EHT-XXX implementation.
...
- Task: Implement endpoints per spec at specs/EHT-XXX-spec.md
...
None session tokens instead of JWT. Check the updated
