...
Prompt: "Review PR #XXX for EHT-YYY. Validate:
...
All QAS reports go to: `docs/agent-outputs/qa-validations/EHT-{number}-qa-validation.md`
...
- **ehtravel-org**: Core agentic principles
