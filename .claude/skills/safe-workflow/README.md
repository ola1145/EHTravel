...
The skill system architecture and EHT harness methodology are the intellectual property of J. Scott Graham and ByBren, LLC.
...
- Start work on a Linear ticket (e.g., "I'm starting EHT-447")
...
Enforces SAFe-compliant development workflow with proper branch naming (`EHT-{number}-{description}`), standardized commit messages (type, scope, description), and rebase-first git workflow. Ensures all work is traceable to Linear tickets.
