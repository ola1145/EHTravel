...
1. `feat(scope): implement data model [EHT-{number}]`
2. `feat(scope): add API endpoint [EHT-{number}]`
3. `feat(scope): create UI component [EHT-{number}]`
4. `test(scope): add unit tests [EHT-{number}]`
...
ls specs/
cat specs/SPEC-EHT-XXX-example.md
```
...
| ------------ | ----------------------------------------------------- |
| Impl specs   | `specs/SPEC-EHT-{number}-{description}.md`            |
| Requirements | `docs/agent-outputs/requirements/EHT-{number}-*.md`   |
...
**Spec**: specs/SPEC-EHT-{number}-{description}.md
