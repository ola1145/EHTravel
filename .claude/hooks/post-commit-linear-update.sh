...
# Extract Linear ticket from commit message (EHT-XXX format)
LINEAR_TICKET=$(echo "$COMMIT_MSG" | grep -oE "EHT-[0-9]+" | head -1)
...
echo "   mcp__linear__create_comment(issueId='$LINEAR_TICKET', body='$COMMENT')"
